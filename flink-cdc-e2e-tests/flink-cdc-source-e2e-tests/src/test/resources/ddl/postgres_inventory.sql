...
ALTER TABLE inventory_regions REPLICA IDENTITY FULL;

-- Create region-based partitions
CREATE TABLE inventory_regions_north PARTITION OF inventory_regions
    FOR VALUES IN ('north', 'northeast', 'northwest');
    
CREATE TABLE inventory_regions_south PARTITION OF inventory_regions  
    FOR VALUES IN ('south', 'southeast', 'southwest');
    
CREATE TABLE inventory_regions_central PARTITION OF inventory_regions
    FOR VALUES IN ('central', 'midwest');

ALTER TABLE inventory_regions_north REPLICA IDENTITY FULL;
ALTER TABLE inventory_regions_south REPLICA IDENTITY FULL;
ALTER TABLE inventory_regions_central REPLICA IDENTITY FULL;

-- Insert test data into partitioned inventory table
INSERT INTO inventory_regions (product_id, warehouse_location, region, stock_quantity)
VALUES 
